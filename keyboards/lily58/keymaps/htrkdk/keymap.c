 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTRL, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L,    KC_ENT,  KC_BSPC,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
           KC_LALT, LGUI_T(KC_MHEN), LT(_LOWER, KC_SPC), KC_SPC, KC_ENT, LT(_RAISE, KC_SPC), RGUI_T(KC_HENK), KC_DEL
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_LOWER] = LAYOUT(
  ...
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, XXXXXXX, XXXXXXX, KC_LABK, KC_RABK, KC_QUES, TT(_FUNCTION),
