...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT(
        ...
        _______, OUT_TOG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LABK, KC_RABK, KC_SLSH, \
        _______, _______,          _______,              _______,  _______,              _______,          _______
    ),
    [_RAISE] = LAYOUT(
        ...
        _______, OUT_TOG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LABK, KC_RABK, KC_QUES, \
        _______, _______,          _______,              _______,  _______,              _______,          _______
    )
};
